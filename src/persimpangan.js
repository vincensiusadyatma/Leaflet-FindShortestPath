const PERSIMPANGAN = [
  { id: "itc-1", vertexType: 'intersection', latitude: -7.748520314216934, longitude: 110.43439865112306, label: 'Jalan Tajem', neighborIds: ["rs-1", 'itc-18', 'itc-2'] },
    ...
    { id: "itc-8", vertexType: 'intersection', latitude: -7.746713061566767, longitude: 110.42521476745607, label: 'Jalan Cindelaras Jaya', neighborIds: ['itc-7', 'itc-9', "rs-12"] },
    { id: "itc-9", vertexType: 'intersection', latitude: -7.746670537881606, longitude: 110.42463541030885, label: 'Gang Madukuro', neighborIds: ['itc-8', 'itc-10', "rs-12"] },
    ...
    { id: "itc-25", vertexType: 'intersection', latitude: -7.754811087571781, longitude: 110.40643125772478, label: 'Jalan Manggis', neighborIds: ['itc-24', "rs-20"] },
    { id: "itc-26", vertexType: 'intersection', latitude: -7.766634935488672, longitude: 110.43109416961671, label: 'Jalan Padjajaran: Ring Road Utara', neighborIds: ['itc-3', "rs-15"] },
    { id: "itc-27", vertexType: 'intersection', latitude: -7.783388138795321, longitude: 110.42972087860109, label: 'Simpang Tiga Maguwo', neighborIds: ["rs-15", 'itc-26', 'itc-29'] },
    ...
    { id: "itc-31", vertexType: 'intersection', latitude: -7.770993383954635, longitude: 110.4164841771126, label: 'Jalan Babarsari', neighborIds: ['itc-30', "rs-13"] },
    { id: "itc-32", vertexType: 'intersection', latitude: -7.783111758889569, longitude: 110.38772821426393, label: 'Jalan Urip Sumoharjo', neighborIds: ['itc-42', 'itc-43', "rs-22"] },
    ...
    { id: "itc-40", vertexType: 'intersection', latitude: -7.768633449180834, longitude: 110.37399262189868, label: 'Jalan Polowijen', neighborIds: ["rs-18"] },
    ...
    { id: "itc-44", vertexType: 'intersection', latitude: -7.776542367502168, longitude: 110.37998199462892, label: 'Jalan Pelangi', neighborIds: ['itc-42', "rs-11"] },
    ...
    { id: "itc-48", vertexType: 'intersection', latitude: -7.785896809605072, longitude: 110.37451028823854, label: 'Jalan Dr. Sutomo', neighborIds: ['itc-47', 'itc-52', "rs-17"] },
    ...
    { id: "itc-55", vertexType: 'intersection', latitude: -7.796675419165053, longitude: 110.36911368370056, label: 'Jalan Sumatra', neighborIds: ['itc-54', "rs-21"] },
    ...
    { id: "itc-58", vertexType: 'intersection', latitude: -7.798570150990592, longitude: 110.40987253189088, label: 'Jalan Sumatra', neighborIds: ['itc-28', 'itc-62', "rs-24"] },
    { id: "itc-59", vertexType: 'intersection', latitude: -7.783281838853151, longitude: 110.3950881958008, label: 'Jalan Laksda Adisucipto', neighborIds: ['itc-50', 'itc-60', "rs-22"] },
    ...
    { id: "itc-67", vertexType: 'intersection', latitude: -7.816828760491538, longitude: 110.3839945793152, label: 'Jalan Sultan Agung', neighborIds: ['itc-68', 'itc-72', "rs-26"] },
    ...
    { id: "itc-71", vertexType: 'intersection', latitude: -7.811535413704974, longitude: 110.38699865341188, label: 'Jalan Urip Sumoharjo', neighborIds: ['itc-70', "rs-26"] },
    { id: "itc-72", vertexType: 'intersection', latitude: -7.814410623448759, longitude: 110.39205193519594, label: 'Jalan Urip Sumoharjo', neighborIds: ["rs-26", 'itc-66'] },
    { id: "itc-73", vertexType: 'intersection', latitude: -7.815330048634235, longitude: 110.3731155395508, label: 'Jalan Laksda Adisucipto', neighborIds: ['itc-68', 'itc-75', "rs-7", 'itc-89'] },
    { id: "itc-74", vertexType: 'intersection', latitude: -7.825417019659343, longitude: 110.3734588623047, label: 'Jalan Sultan Agung', neighborIds: ['itc-76', "rs-8", '73', "rs-7"] },
    { id: "itc-75", vertexType: 'intersection', latitude: -7.814681668078089, longitude: 110.36845922470094, label: 'Jalan Sunan Kalijaga', neighborIds: ['itc-76', 'itc-73', 'itc-80', "rs-25"] },
    ...
    { id: "itc-83", vertexType: 'intersection', latitude: -7.801588080036997, longitude: 110.36926509188282, label: 'Jalan Sultan Agung', neighborIds: ['itc-61', 'itc-70', "rs-25"] },
    ...
    { id: "itc-86", vertexType: 'intersection', latitude: -7.866740225151292, longitude: 110.33839702606201, label: 'Jalan Laksda Adisucipto', neighborIds: ['itc-79', "rs-4", '87'] },
    ...
    {id: "itc-88", vertexType: 'intersection', latitude: -7.824800541600952, longitude: 110.37842631340028, label: 'Jalan Tritunggal', neighborIds: ['itc-74', 'itc-89', "rs-8"]},
    {id: "itc-89", vertexType: 'intersection', latitude: -7.815702069810121, longitude: 110.37619471549989, label: 'Jalan Menteri Supeno', neighborIds:["rs-7", ]}
]
