const PERSIMPANGAN = [
  { id: "itc-1", vertexType: 'intersection', latitude: -7.748520314216934, longitude: 110.43439865112306, label: 'Jalan Tajem', neighborIds: ["rs-umum-daerah-wates", 'itc-18', 'itc-2'] },
    ...
    { id: "itc-5", vertexType: 'intersection', latitude: -7.751356090608056, longitude: 110.4286399483681, label: 'Jalan Stadion Maguwoharjo', neighborIds: ['itc-13', 'itc-2', 'itc-12'] },
    ...
    { id: "itc-7", vertexType: 'intersection', latitude: -7.745075896589286, longitude: 110.42519330978395, label: 'Jalan Raya Pringgondani 2', neighborIds: ['itc-5', 'itc-17', 'itc-8'] },
    ...
    { id: "itc-12", vertexType: 'intersection', latitude: -7.7503275591105565, longitude: 110.4224681854248, label: 'Patung Elang Jawa', neighborIds: ['itc-11', 'itc-5', 'itc-16'] },
    ...
    { id: "itc-16", vertexType: 'intersection', latitude: -7.752831112012443, longitude: 110.41960358619691, label: 'Jalan Kepuhsari', neighborIds: ['itc-15', 'itc-12'] },
    ...
    { id: "itc-26", vertexType: 'intersection', latitude: -7.766634935488672, longitude: 110.43109416961671, label: 'Jalan Padjajaran: Ring Road Utara', neighborIds: ['itc-3', "rs-hermina"] },
    { id: "itc-27", vertexType: 'intersection', latitude: -7.783388138795321, longitude: 110.42972087860109, label: 'Simpang Tiga Maguwo', neighborIds: ["rs-hermina", 'itc-26', 'itc-29'] },
    { id: "itc-28", vertexType: 'intersection', latitude: -7.783281838853151, longitude: 110.41049480438234, label: 'Simpang Tiga Janti', neighborIds: ['itc-29', 'itc-50'] },
    ...
    { id: "itc-30", vertexType: 'intersection', latitude: -7.774166518585417, longitude: 110.41586190462114, label: 'Jalan Babarsari', neighborIds: ['itc-29', 'itc-31', 'itc-129'] },
    ...
    { id: "itc-32", vertexType: 'intersection', latitude: -7.783111758889569, longitude: 110.38772821426393, label: 'Jalan Urip Sumoharjo', neighborIds: ['itc-42', 'itc-43', "rs-siloam-yogyakarta"] },
    { id: "itc-33", vertexType: 'intersection', latitude: -7.758425515567794, longitude: 110.39569169282915, label: 'Simpang Empat Condongcatur', neighborIds: ['itc-37', 'itc-20'] },
    ...
    { id: "itc-35", vertexType: 'intersection', latitude: -7.754920052399183, longitude: 110.38324356079103, label: 'Jalan Kaliurang', neighborIds: ['itc-33', 'itc-38'] },
    { id: "itc-35", vertexType: 'intersection', latitude: -7.754920052399183, longitude: 110.38324356079103, label: 'Jalan Kaliurang', neighborIds: ['itc-38', 'itc-90', 'itc-117'] },
    ...
    { id: "itc-38", vertexType: 'intersection', latitude: -7.765784501246444, longitude: 110.37856578826906, label: 'Jalan Argo', neighborIds: ['itc-39', 'itc-35', 'itc-38', 'itc-37'] },
    ...
    { id: "itc-41", vertexType: 'intersection', latitude: -7.761787437252218, longitude: 110.41201829910278, label: 'Jalan Perumnas', neighborIds: [] },
    { id: "itc-42", vertexType: 'intersection', latitude: -7.777860506064949, longitude: 110.3886079788208, label: 'Jalan Veteran', neighborIds: ['itc-125','itc-32', 'itc-44'] },
    { id: "itc-43", vertexType: 'intersection', latitude: -7.783069238887897, longitude: 110.37923097610474, label: 'Jalan Anggrek', neighborIds: ['itc-44', 'itc-32', 'itc-36', 'itc-56'] },
    ...
    { id: "itc-49", vertexType: 'intersection', latitude: -7.764274976226991, longitude: 110.4110097885132, label: 'Jalan Persatuan', neighborIds: ['itc-41', 'itc-128'] },
    { id: "itc-50", vertexType: 'intersection', latitude: -7.783239318868718, longitude: 110.4083275794983, label: 'Jalan Sisingamangaraja', neighborIds: ['itc-28', 'itc-126', 'itc-92'] },
    { id: "itc-51", vertexType: 'intersection', latitude: -7.797260049816141, longitude: 110.37766993045808, label: 'Jalan Gadjah Mada', neighborIds: ['itc-55', 'itc-69', 'itc-56'] },
    ...
    { id: "itc-56", vertexType: 'intersection', latitude: -7.789999942200338, longitude: 110.37820369005205, label: 'Jalan Java', neighborIds: ['itc-51', 'itc-54', 'itc-60', 'itc-43'] },
    { id: "itc-57", vertexType: 'intersection', latitude: -7.769122445763837, longitude: 110.40208339691164, label: 'Jalan Bali', neighborIds: ['itc-121', 'itc-20', 'itc-127'] },
    { id: "itc-58", vertexType: 'intersection', latitude: -7.798570150990592, longitude: 110.40987253189088, label: 'Jalan Sumatra', neighborIds: ['itc-28', 'itc-62', "rs-drs-hardjolukito"] },
    { id: "itc-59", vertexType: 'intersection', latitude: -7.783281838853151, longitude: 110.3950881958008, label: 'Jalan Laksda Adisucipto', neighborIds: ['itc-50', 'itc-60', "rs-siloam-yogyakarta"] },
    { id: "itc-60", vertexType: 'intersection', latitude: -7.792551092460299, longitude: 110.3930711746216, label: 'Jalan Yos Sudarso', neighborIds: ['itc-59', 'itc-23', 'itc-69', 'itc-70'] },
    { id: "itc-61", vertexType: 'intersection', latitude: -7.796675419165053, longitude: 110.36911368370056, label: 'Jalan Kusumanegara', neighborIds: ['itc-55', 'itc-83'] },
    ...
    { id: "itc-66", vertexType: 'intersection', latitude: -7.813331757787917, longitude: 110.39612352848053, label: 'Jalan Dr. Wahidin', neighborIds: ['itc-65', 'itc-72'] },
    { id: "itc-67", vertexType: 'intersection', latitude: -7.816828760491538, longitude: 110.3839945793152, label: 'Jalan Sultan Agung', neighborIds: ['itc-68', 'itc-72', "rs-hidayatullah"] },
    { id: "itc-68", vertexType: 'intersection', latitude: -7.816435482014306, longitude: 110.38142502307893, label: 'Jalan Sunan Kalijaga', neighborIds: ["rs-27", 'itc-67'] },
    ...
    { id: "itc-71", vertexType: 'intersection', latitude: -7.811535413704974, longitude: 110.38699865341188, label: 'Jalan Urip Sumoharjo', neighborIds: ['itc-70', "rs-hidayatullah"] },
    { id: "itc-72", vertexType: 'intersection', latitude: -7.814410623448759, longitude: 110.39205193519594, label: 'Jalan Urip Sumoharjo', neighborIds: ["rs-hidayatullah", 'itc-66'] },
    { id: "itc-73", vertexType: 'intersection', latitude: -7.815330048634235, longitude: 110.3731155395508, label: 'Jalan Laksda Adisucipto', neighborIds: ['itc-68', 'itc-75', "rs-pratama", 'itc-89'] },
    { id: "itc-74", vertexType: 'intersection', latitude: -7.825417019659343, longitude: 110.3734588623047, label: 'Jalan Sultan Agung', neighborIds: ['itc-76', "rs-jogja", '73', "rs-pratama"] },
    { id: "itc-75", vertexType: 'intersection', latitude: -7.814681668078089, longitude: 110.36845922470094, label: 'Jalan Sunan Kalijaga', neighborIds: ['itc-76', 'itc-73', 'itc-80', "tht-dr-pomo"] },
    ...
    { id: "itc-78", vertexType: 'intersection', latitude: -7.833346121669659, longitude: 110.3589963912964, label: 'Jalan Dr. Wahidin', neighborIds: ['itc-77', "rs-9", 'itc-79'] },
    ...
    { id: "itc-83", vertexType: 'intersection', latitude: -7.801588080036997, longitude: 110.36926509188282, label: 'Jalan Sultan Agung', neighborIds: ['itc-61', 'itc-70', "tht-dr-pomo"] },
    ...
    {id: "itc-88", vertexType: 'intersection', latitude: -7.824800541600952, longitude: 110.37842631340028, label: 'Jalan Tritunggal', neighborIds: ['itc-74', 'itc-89', "rs-jogja"]},
    {id: "itc-89", vertexType: 'intersection', latitude: -7.815702069810121, longitude: 110.37619471549989, label: 'Jalan Menteri Supeno', neighborIds:["rs-pratama", ]},
    ...
    {id: 'itc-92', vertexType: 'intersection', latitude: -7.773587170836495, longitude: 110.40903568267824, label: 'Jalan Seturan', neighborIds: ['itc-128', 'itc-50', 'itc-129']},
    ...
    {id: 'itc-119', vertexType: 'intersection', latitude: -7.75621699744626, longitude: 110.3697681427002, label: 'Jalan Tirtamarga', neighborIds: ['itc-118', 'itc-114', 'itc-120']},
    {id: 'itc-120', vertexType: 'intersection', latitude: -7.751241809454663, longitude: 110.37120580673218, label: 'Simpang Empat Monjali', neighborIds: ['itc-117', 'itc-119']},
    {id: 'itc-121', vertexType: 'intersection', latitude: -7.767974365928978, longitude: 110.3958284854889, label: 'Jalan inspeksi selokan Mataram', neighborIds: ['itc-57', 'itc-123']},
    {id: 'itc-122', vertexType: 'intersection', latitude: -7.767565095969818, longitude: 110.39203047752382, label: 'Jalan inspeksi selokamn Mataram', neighborIds: ['itc-37', 'itc-123']},
    {id: 'itc-123', vertexType: 'intersection', latitude: -7.767570411166649, longitude: 110.39279222488403, label: 'Jalan inspeksi selokamn Mataram', neighborIds: ['itc-122', 'itc-123', 'itc-124']},
    {id: 'itc-124', vertexType: 'intersection', latitude: -7.774586412325599, longitude: 110.391343832016, neighborIds: ['itc-123', 'itc-125'], label: 'Gang Argulo'},
    {id: 'itc-125', vertexType: 'intersection', latitude: -7.7741612034720955, longitude: 110.38933753967285, neighborIds: ['itc-124', 'itc-42', 'itc-37']},
    {id: 'itc-126', vertexType: 'intersection', latitude: -7.783111758889569, longitude: 110.39946556091309, neighborIds: ['itc-57', 'itc-59', 'itc-50']},
    {id: 'itc-127', vertexType: 'intersection', latitude: -7.771099687010633, longitude: 110.40502309799194, label: 'Jalan inspeksi selokan Mataram', neighborIds: ['itc-57', 'itc-128']},
    {id: 'itc-128', vertexType: 'intersection', latitude: -7.772332800493182, longitude: 110.40927171707155, label: 'Jalan inspeksi selokan Mataram', neighborIds: ['itc-127', ]},
    {id: 'itc-129', vertexType: 'intersection', latitude: -7.773948598883778, longitude: 110.41178226470949, label: 'Jalan Babarsari Raya', neighborIds: ['itc-30', 'itc-92']}
]
