const PERSIMPANGAN = [
  { id: "itc-1", vertexType: 'intersection', latitude: -7.748520314216934, longitude: 110.43439865112306, label: 'Jalan Tajem', neighborIds: ["rs-medika-respati", 'itc-18', 'itc-2'] },
    ...
    { id: "itc-44", vertexType: 'intersection', latitude: -7.776542367502168, longitude: 110.37998199462892, label: 'Jalan Pelangi', neighborIds: ['itc-42', 'itc-111', 'itc-43']},
    ...
    { id: "itc-58", vertexType: 'intersection', latitude: -7.798570150990592, longitude: 110.40987253189088, label: 'Jalan Sumatra', neighborIds: ['itc-28', 'itc-62', 'itc-93', 'itc-146']},
    ...
    { id: "itc-74", vertexType: 'intersection', latitude: -7.825417019659343, longitude: 110.3734588623047, label: 'Jalan Sultan Agung', neighborIds: ['itc-76', "rs-jogja", 'itc-73', "rs-pratama", 'itc-150'] },
    ...
    {id: "itc-88", vertexType: 'intersection', latitude: -7.824800541600952, longitude: 110.37842631340028, label: 'Jalan Tritunggal', neighborIds: ['itc-104', 'itc-89', 'itc-151']},
    ...
    {id: 'itc-92', vertexType: 'intersection', latitude: -7.773587170836495, longitude: 110.40903568267824, label: 'Jalan Seturan', neighborIds: ['itc-135', 'itc-50']},
    ...
    {id: 'itc-114', vertexType: 'intersection', latitude: -7.7620000479963975, longitude: 110.36938190460206, label: 'Jalan Selokan Mataram', neighborIds: ['itc-38', 'itc-115', 'itc-143']},
    ...
    {id: 'itc-140', vertexType: 'intersection', latitude: -7.754446985382796, longitude: 110.40499091148378, label: 'Jalan Gempol Raya', neighborIds: ['itc-141', 'itc-25']},
    ...
    {id: 'itc-142', vertexType: 'intersection', latitude: -7.754356624206806, longitude: 110.3827339410782, label: 'jalan Padjajaran', neighborIds: ['itc-35', 'itc-143']},
    ...
    {id: 'itc-145', vertexType: 'intersection', latitude: -7.782867268821041, longitude: 110.36703228950502, label: 'Jalan Diponegoro', neighborIds: ['itc-144', 'itc-112']},
    ...
    {id: 'itc-153', vertexType: 'intersection', latitude: -7.822058266089522, longitude: 110.32814025878908, label: 'Jalan Brawijaya', neighborIds: ['itc-152']}
]
